package paula_bugsorting.model;

import java.text.DateFormat;
import java.text.SimpleDateFormat;
import java.util.Date;

public class BugReportOpen implements Comparable<BugReportOpen> {
	...
	public String toString() {
		...
		+ ", openDate=" + df.format(openDate) + ", severeness=" + severeness + "]";
	}

	@Override
	public int compareTo(BugReportOpen o) {
